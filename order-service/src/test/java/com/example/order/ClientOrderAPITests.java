...
public class ClientOrderAPITests {
    ...
    public void addOrder() {
        ...
        com.example.order.model.inner.Tag tag1 = new com.example.order.model.inner.Tag();
        tag1.setName("1t");
        tag1 = tagRepository.save(tag1);
        TagDto tagDto1 = dataTransformer.tagToDto(tag1);

        com.example.order.model.inner.Tag tag2 = new com.example.order.model.inner.Tag();
        tag2.setName("2t");
        tag2 = tagRepository.save(tag2);
        TagDto tagDto2 = dataTransformer.tagToDto(tag2);

        com.example.order.model.inner.Tag tag3 = new com.example.order.model.inner.Tag();
        tag3.setName("3t");
    ...
    public void updateOrder() {
        ...
        com.example.order.model.inner.Tag tag1 = tagRepository.findByName("1t").orElseThrow();
        com.example.order.model.inner.Tag tag2 = tagRepository.findByName("2t").orElseThrow();
...
//        Tag tag2 = tagRepository.findByName("2t").orElseThrow();
        com.example.order.model.inner.Tag tag3 = tagRepository.findByName("3t").orElseThrow();
