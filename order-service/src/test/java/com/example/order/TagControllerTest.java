...
public class TagControllerTest {
    ...
    void saveAPICorrect() {
        ...
        Assertions.assertAll(
                ...
                () -> {
                    com.example.order.model.inner.Tag tag = tagRepository.findByName(tagName).orElseThrow();
    ...
    void removeTagFromOrderAPICorrect() {
        ...
        String tagName = "Programmer";
        com.example.order.model.inner.Tag progTag = tagRepository.findByName(tagName).orElseThrow();
